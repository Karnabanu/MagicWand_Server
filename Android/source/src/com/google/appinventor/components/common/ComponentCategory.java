...
public final class ComponentCategory extends Enum
{
    ...
    public static final ComponentCategory EXPERIMENTAL;
    ...
    static 
    {
        ...
        INTERNAL = new ComponentCategory("INTERNAL", 10, "For internal use only");
        UNINITIALIZED = new ComponentCategory("UNINITIALIZED", 11, "Uninitialized");
        $VALUES = (new ComponentCategory[] {
            USERINTERFACE, LAYOUT, MEDIA, ANIMATION, SENSORS, SOCIAL, STORAGE, CONNECTIVITY, LEGOMINDSTORMS, EXPERIMENTAL, 
