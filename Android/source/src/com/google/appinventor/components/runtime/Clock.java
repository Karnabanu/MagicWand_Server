    ...
    implements Component, AlarmHandler, OnStopListener, OnResumeListener, OnDestroyListener, Deleteable
{
    ...
    public static Calendar AddDuration(Calendar calendar, long l)
    {
        calendar = (Calendar)calendar.clone();
        Dates.DateAddInMillis(calendar, l);
        return calendar;
    }
    ...
    public static long DurationToDays(long l)
    {
        return Dates.ConvertDuration(l, 5);
    }

    public static long DurationToHours(long l)
    {
        return Dates.ConvertDuration(l, 11);
    }

    public static long DurationToMinutes(long l)
    {
        return Dates.ConvertDuration(l, 12);
    }

    public static long DurationToSeconds(long l)
    {
        return Dates.ConvertDuration(l, 13);
    }

    public static long DurationToWeeks(long l)
    {
        return Dates.ConvertDuration(l, 3);
    }
    ...
    public static String FormatDate(Calendar calendar, String s)
    {
        try
        {
            calendar = Dates.FormatDate(calendar, s);
        }
    ...
    public static String FormatDateTime(Calendar calendar, String s)
    {
        try
        {
            calendar = Dates.FormatDateTime(calendar, s);
        }
        // Misplaced declaration of an exception variable
        catch (Calendar calendar)
        {
