    ...
    implements android.widget.AdapterView.OnItemClickListener
{
    ...
    private static final int DEFAULT_SELECTION_COLOR = 0xffcccccc;
    ...
    {
        selectionColor = i;
        view.setSelector(new GradientDrawable(android.graphics.drawable.GradientDrawable.Orientation.TOP_BOTTOM, new int[] {
            i, i
        }));
    }
