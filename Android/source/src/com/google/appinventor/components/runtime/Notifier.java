    ...
    implements Component
{
    ...
    private void textInputDialog(final String input, final String cancelButtonText, boolean flag)
    {
        ...
        if (flag)
        {
            cancelButtonText = activity.getString(0x1040000);
            alertdialog.setButton(-2, cancelButtonText, new android.content.DialogInterface.OnClickListener() {
            ...
            Runnable runnable2)
    {
        ...
        AlertDialog alertdialog = (new android.app.AlertDialog.Builder(activity1)).create();
        alertdialog.setTitle(s1);
        alertdialog.setCancelable(false);
        alertdialog.setMessage(stringToHTML(s));
        alertdialog.setButton(-1, s2, new android.content.DialogInterface.OnClickListener(runnable) {
        ...
        alertdialog.setButton(-3, s3, new android.content.DialogInterface.OnClickListener(runnable1) {
        ...
        if (flag)
        {
            alertdialog.setButton(-2, activity1.getString(0x1040000), new android.content.DialogInterface.OnClickListener(runnable2) {
    ...
    public void ShowChooseDialog(String s, String s1, final String button1Text, final String button2Text, boolean flag)
    {
        twoButtonDialog(activity, s, s1, button1Text, button2Text, flag, new Runnable() {
            ...
            public void run()
            {
                AfterChoosing(activity.getString(0x1040000));
            }
